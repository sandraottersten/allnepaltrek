...
<div
	...
	class="flex h-80 items-center justify-center overflow-hidden bg-[image:var(--image-mob)] bg-cover bg-center bg-no-repeat md:hidden"
>
	<button
...
{#if images.length === 3}
	<section
		id="gallery"
		class="scroll-block relative mx-auto hidden flex-col gap-2 overflow-hidden rounded-lg md:flex"
	>
		<!-- row 1 -->
